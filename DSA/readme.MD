Akamai Terraform Provider template for DSA

This Akamai Terraform Provider template can be used to onboard a brand new set of infrastructure with Akamai. This template is designed to create an Akamai Delivery configuration, tied to the Dynamic Site Accelerator (DSA) solution.
...
2) Navigate to the examples-terraform/DSA folder
...
Following these steps should create your Akamai DSA configuration as well as activate the CP Code and Edge Hostname that you have specified.
