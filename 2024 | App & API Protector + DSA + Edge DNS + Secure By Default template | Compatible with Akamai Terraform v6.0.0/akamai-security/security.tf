...
resource "akamai_appsec_activations" "activation" {
  ...
  notification_emails = [ var.email ]
  version = var.activate_latest_on_staging ? akamai_appsec_configuration.akamai_appsec.latest_version.latest_version : akamai_appsec_configuration.akamai_appsec.latest_version.staging_version
...
resource "akamai_appsec_activations" "activation-production" {
  ...
  network = "PRODUCTION"
  notification_emails = [ var.email ]
  version = var.activate_latest_on_production ? akamai_appsec_configuration.akamai_appsec.latest_version.latest_version : akamai_appsec_configuration.akamai_appsec.latest_version.production_version
